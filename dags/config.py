...
PREDICTIONS_BOOSTED_FOLDER = os.path.join(DATA_FOLDER, 'predictions',"boosting")
...
MODEL_BOOSTING_REGISTRY_FOLDER = os.path.join(PROJECT_FOLDER, 'models','boosting')
MODEL_BOOSTING_PATH = os.path.join(MODEL_BOOSTING_REGISTRY_FOLDER, '20230908-131919.joblib')


# Add your initials to the monitoring table name
MONITORING_TABLE_NAME = 'dp_monitoring'
